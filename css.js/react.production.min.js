...
function() {
    ...
    function q(a) {
        ...
        g = 0; g < b; g++) d += "&args[]=" + encodeURIComponent(arguments[g + 1]);
    ...
    function T(a, b, d, g) {
        ...
        if (Array.isArray(a)) for (var f = 0; f < a.length; f++) {
            ...
            var h = b + U(c, f);
            e += T(c, h, d, g)
        } else if (null === a || "object" !== typeof a ? h = null: (h = ka && a[ka] || a["@@iterator"], h = "function" === typeof h ? h: null), "function" === typeof h) for (a = h.call(a), f = 0; ! (c = a.next()).done;) c = c.value,
        h = b + U(c, f++),
        e += T(c, h, d, g);
    ...
    J(e, {
        Scheduler: {
            ...
            unstable_scheduleCallback: function(a, b) {
                ...
                if (null === c) c = a.next = a.previous = a,
                u();
                else {
                    d = null;
                    var g = c;
